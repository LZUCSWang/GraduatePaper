...
\begin{algorithm}[H]
	...
	\begin{algorithmic}[1]
		...
		\While{$M_u \neq \emptyset$}
		\State $E_u^{rel} \gets \text{路径规划}(M_u, P_u^{self})$ \Comment{使用算法\ref{alg:grp_main_training}训练的模型进行第一次路径规划}
		...
		\State $E_u^{r2} \gets \text{路径规划}(M_u^{tmp}, P_u^{self})$ \Comment{使用算法\ref{alg:grp_main_training}训练的模型进行第二次路径规划}
...
\begin{figure}[H]
	...
	\subfloat[60点600边长4机]{\includesvg[width=0.32\textwidth]{figures/DRL/cvrp_60_600_4_multi_route_DRL.svg}\label{fig:DRL_60_600_4}}
	\subfloat[60点600边长6机]{\includesvg[width=0.32\textwidth]{figures/DRL/cvrp_60_600_6_multi_route_DRL.svg}\label{fig:DRL_60_600_6}}
	\subfloat[60点600边长8机]{\includesvg[width=0.32\textwidth]{figures/DRL/cvrp_60_600_8_multi_route_DRL.svg}\label{fig:DRL_60_600_8}}\\
	\subfloat[60点700边长4机]{\includesvg[width=0.32\textwidth]{figures/DRL/cvrp_60_700_4_multi_route_DRL.svg}\label{fig:DRL_60_700_4}}
	\subfloat[60点700边长6机]{\includesvg[width=0.32\textwidth]{figures/DRL/cvrp_60_700_6_multi_route_DRL.svg}\label{fig:DRL_60_700_6}}
	\subfloat[60点700边长8机]{\includesvg[width=0.32\textwidth]{figures/DRL/cvrp_60_700_8_multi_route_DRL.svg}\label{fig:DRL_60_700_8}}
...
\begin{figure}[H]
	\centering
	\subfloat[60点500边长4机]{\includesvg[width=0.32\textwidth]{figures/CHAPBILM/cvrp_60_500_4_multi_route_CHAPBILM.svg}\label{fig:ILS_60_500_4}}
	\subfloat[60点500边长6机]{\includesvg[width=0.32\textwidth]{figures/CHAPBILM/cvrp_60_500_6_multi_route_CHAPBILM.svg}\label{fig:ILS_60_500_6}} 
	\subfloat[60点500边长8机]{\includesvg[width=0.32\textwidth]{figures/CHAPBILM/cvrp_60_500_8_multi_route_CHAPBILM.svg}\label{fig:ILS_60_500_8}}\\
	\subfloat[60点600边长4机]{\includesvg[width=0.32\textwidth]{figures/CHAPBILM/cvrp_60_600_4_multi_route_CHAPBILM.svg}\label{fig:ILS_60_600_4}}
	\subfloat[60点600边长6机]{\includesvg[width=0.32\textwidth]{figures/CHAPBILM/cvrp_60_600_6_multi_route_CHAPBILM.svg}\label{fig:ILS_60_600_6}}
	\subfloat[60点600边长8机]{\includesvg[width=0.32\textwidth]{figures/CHAPBILM/cvrp_60_600_8_multi_route_CHAPBILM.svg}\label{fig:ILS_60_600_8}}\\
	\subfloat[60点700边长4机]{\includesvg[width=0.32\textwidth]{figures/CHAPBILM/cvrp_60_700_4_multi_route_CHAPBILM.svg}\label{fig:ILS_60_700_4}}
	\subfloat[60点700边长6机]{\includesvg[width=0.32\textwidth]{figures/CHAPBILM/cvrp_60_700_6_multi_route_CHAPBILM.svg}\label{fig:ILS_60_700_6}}
	\subfloat[60点700边长8机]{\includesvg[width=0.32\textwidth]{figures/CHAPBILM/cvrp_60_700_8_multi_route_CHAPBILM.svg}\label{fig:ILS_60_700_8}}
